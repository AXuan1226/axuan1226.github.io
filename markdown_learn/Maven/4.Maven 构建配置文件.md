...
<img src="\Maven\img\ma4_2.png">

可以看出成功的触发了AntRun的任务。并且是对应**构建配置文件**下的 <id> 为 test 的任务。

再测试其余两个命令，结果如下：

<img src="\Maven\img\ma4_3.png">

<img src="\Maven\img\ma4_4.png">
